...
export default function Welcome(props) {
  ...
  return (
    <Container sx={{ color: 'rgb(255,255,255)', textAlign: 'center', height: '82vh' }} >
            ...
            <Button  variant='contained' elevation={0} endIcon={<ShoppingBasketTwoTone/>} color='error' to={'/products/all'} component={Link} sx={{ paddingX: 2.5, color: 'rgb(255,255,255)', outlineColor: 'white', outlineStyle: 'ridge' }}>
              Shop Now
            </Button>
          </Container>
